...
from wenet.transformer.encoder import SChunkTransformerEncoder
from wenet.transformer.encoder import SChunkConformerEncoder
...
def init_asr_model(configs):
    ...
    elif encoder_type == 'schunk-transformer':
        encoder = SChunkTransformerEncoder(input_dim,
                                    global_cmvn=global_cmvn,
                                   **configs['encoder_conf'])
    elif encoder_type == 'schunk-conformer':
        encoder = SChunkConformerEncoder(input_dim,
                                    global_cmvn=global_cmvn,
                                   **configs['encoder_conf'])
    else:
